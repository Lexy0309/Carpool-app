...
export class LocationPage {
	...
	constructor(public translate:TranslateService,public navCtrl: NavController, public geolocation: Geolocation, private androidPermissions: AndroidPermissions) {
